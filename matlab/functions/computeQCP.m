...
% New version that incorporates OLA processing (variable tmarks) (Joan Claudi Socor�)
%
% Inputs:
%
% s:        [Nx1]	Speech signal 
...
for n = 1:nf
    ...
    Hg = lpc(win(sg,winfunc),g);   % JC. Abans posava Hg = lpc(win(sg,winfunc),g) però aleshores Hg era una matriu, pel fet que win(sg',winfunc) era un vector columna (??)
